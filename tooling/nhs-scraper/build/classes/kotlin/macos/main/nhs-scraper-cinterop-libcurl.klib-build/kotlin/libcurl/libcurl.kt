...
@CStruct("struct { int p0; int p1; int p2; unsigned int p3; struct { unsigned char p0; unsigned char p1; char p2[14]; } p4; }")
...
@CCall("knifunptr_libcurl47_curl_easy_upkeep")
external fun curl_easy_upkeep(curl: CValuesRef<*>?): CURLcode

@CCall("knifunptr_libcurl48_curl_multi_init")
external fun curl_multi_init(): COpaquePointer?

@CCall("knifunptr_libcurl49_curl_multi_add_handle")
external fun curl_multi_add_handle(multi_handle: CValuesRef<*>?, curl_handle: CValuesRef<*>?): CURLMcode

@CCall("knifunptr_libcurl50_curl_multi_remove_handle")
external fun curl_multi_remove_handle(multi_handle: CValuesRef<*>?, curl_handle: CValuesRef<*>?): CURLMcode

@CCall("knifunptr_libcurl51_curl_multi_fdset")
...
@CCall("knifunptr_libcurl52_curl_multi_wait")
...
@CCall("knifunptr_libcurl59_curl_multi_socket_all")
external fun curl_multi_socket_all(multi_handle: CValuesRef<*>?, running_handles: CValuesRef<IntVar>?): CURLMcode

@CCall("knifunptr_libcurl60_curl_multi_timeout")
external fun curl_multi_timeout(multi_handle: CValuesRef<*>?, milliseconds: CValuesRef<LongVar>?): CURLMcode

@CCall("knifunptr_libcurl61_curl_multi_setopt")
external fun curl_multi_setopt(multi_handle: CValuesRef<*>?, option: CURLMoption, vararg variadicArguments: Any?): CURLMcode

@CCall("knifunptr_libcurl62_curl_multi_assign")
external fun curl_multi_assign(multi_handle: CValuesRef<*>?, sockfd: curl_socket_t, sockp: CValuesRef<*>?): CURLMcode

@CCall("knifunptr_libcurl63_curl_pushheader_bynum")
external fun curl_pushheader_bynum(h: CValuesRef<curl_pushheaders>?, num: size_t): CPointer<ByteVar>?

@CCall("knifunptr_libcurl64_curl_pushheader_byname")
external fun curl_pushheader_byname(h: CValuesRef<curl_pushheaders>?, @CCall.CString name: String?): CPointer<ByteVar>?

@CCall("knifunptr_libcurl65_curl_url")
external fun curl_url(): CPointer<CURLU>?

@CCall("knifunptr_libcurl66_curl_url_cleanup")
external fun curl_url_cleanup(handle: CValuesRef<CURLU>?): Unit

@CCall("knifunptr_libcurl67_curl_url_dup")
external fun curl_url_dup(`in`: CValuesRef<CURLU>?): CPointer<CURLU>?

@CCall("knifunptr_libcurl68_curl_url_get")
external fun curl_url_get(handle: CValuesRef<CURLU>?, what: CURLUPart, part: CValuesRef<CPointerVar<ByteVar>>?, flags: UInt): CURLUcode

@CCall("knifunptr_libcurl69_curl_url_set")
external fun curl_url_set(handle: CValuesRef<CURLU>?, what: CURLUPart, @CCall.CString part: String?, flags: UInt): CURLUcode

val LIBCURL_COPYRIGHT: String get() = "1996 \u002D 2019 Daniel Stenberg, \u003Cdaniel@haxx.se\u003E."

val LIBCURL_VERSION: String get() = "7.64.1"

const val LIBCURL_VERSION_MAJOR: Int = 7

const val LIBCURL_VERSION_MINOR: Int = 64

const val LIBCURL_VERSION_PATCH: Int = 1

const val LIBCURL_VERSION_NUM: Int = 475137

val LIBCURL_TIMESTAMP: String get() = "2019\u002D03\u002D27"
...
const val CURLALTSVC_ALTUSED: Int = 2
...
val CURL_LAST: CURLcode get() = 94u
...
val CURLOPT_LASTENTRY: CURLoption get() = 10288u

typealias CURLoptionVar = UIntVarOf<CURLoption>

typealias CURLoption = UInt

// enum (anonymous at /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.15.sdk/usr/include/curl/curl.h:1962:1):
...
// enum (anonymous at /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.15.sdk/usr/include/curl/curl.h:1984:1):
...
// enum (anonymous at /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.15.sdk/usr/include/curl/curl.h:2012:1):
...
// enum (anonymous at /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.15.sdk/usr/include/curl/curl.h:2025:1):
...
val CURLINFO_LASTONE: CURLINFO get() = 56u
